...
<p class="has-line-data" data-line-start="2" data-line-end="3">Список классов находится в файле конфигурации <code>/project/core/custom/configs/scraper.php</code>.
</p>
<p class="has-line-data" data-line-start="4" data-line-end="5">Вы можете как создавать классы с нуля, так и
    наследоваться от <code>EvolutionCMS\Scraper\Services\Parsers\AbstractParser</code>. Для лучшего понимания,
...
<p class="has-line-data" data-line-start="18" data-line-end="20"><code>php artisan scraper:process
    ...
    Игнорирует поле метки времени (по-умолчанию обрабатываются задания, timestamp которых не указывает на дату из будущего).</p>
<p class="has-line-data" data-line-start="21" data-line-end="23"><code>php artisan scraper:mark-tasks</code><br>
    Меняет статус всех Completed заданий без документов на Created.</p>
