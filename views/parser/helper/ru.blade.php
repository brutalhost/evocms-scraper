...
<h3 class="code-line" data-line-start=5 data-line-end=6><a id="__5"></a>Обработка задач</h3>
...
<p class="has-line-data" data-line-start="21" data-line-end="23"><code>php artisan scraper:mark-tasks</code><br>
    Изменяет статус на Created для всех задач Completed, к которым не прикреплены документы.</p>
